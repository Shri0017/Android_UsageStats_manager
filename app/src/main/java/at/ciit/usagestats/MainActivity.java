...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadStatistics() {
        ...
        System.out.println("--------------------");
        Map<Integer,String> UserJourneyMap = new TreeMap<>();
//        System.out.println(Arrays.toString(appList.toArray()));
//            ListView listView;
//            listView.setAdapter(appList);
        ...
        appList.forEach((item)->{
            ...
            System.out.println("application opened before : "+getDurationBreakdown(System.currentTimeMillis() - item.getLastTimeVisible())+" milliseconds");
            System.out.println("Last Time Visible : "+getDurationBreakdown(item.getLastTimeVisible()));
            DateFormat df = new SimpleDateFormat("dd-MM-yy HH:mm:SS z");
            df.setTimeZone(TimeZone.getTimeZone("Asia/Kolkata"));
            String IST = df.format(new Date(item.getLastTimeVisible()));
            System.out.println("Last Time Visible This application open at (IST) : " + IST);
            String IST1 = df.format(new Date(item.getLastTimeUsed()));
             System.out.println("Last Time Used : " + IST1);
